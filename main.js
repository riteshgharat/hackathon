...
if (synth) {
  ...
  function explore() {
    function story() {
      ...
      if (location.hash == '#chatbot' && !synth.speaking) { stopVoice() }
    }
  ...
  function speak1() {
    ...
    startSpeak(`${data[0].title} ${data[0].info}`);
  }

  function speak2() {
    location.hash = 'machine_learning';
    startSpeak(`${data[1].title} ${data[1].info}`);
  }

  function speak3() {
    location.hash = 'self_driving_car';
    startSpeak(`${data[2].title} ${data[2].info}`);
  }

  function speak4() {
    location.hash = 'chatbot';
    startSpeak(`${data[3].title} ${data[3].info}`);
  }
